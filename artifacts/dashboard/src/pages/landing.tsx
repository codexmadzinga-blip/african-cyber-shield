...
const STATS = [
  { value: "14", label: "Heuristic Checks Per Scan" },
  { value: "60+", label: "African Brands Monitored" },
  { value: "< 80ms", label: "Average Scan Time" },
  { value: "OWASP", label: "Top 10 Severity Mapped" },
];
...
const PRICING = [
  {
    ...
    price: "$0",
    period: "forever",
    desc: "For individuals securing their personal accounts and devices.",
    features: [
      "URL phishing scanner (unlimited)",
      "Password strength & entropy checker",
      "2FA setup guides for 14+ platforms",
  ...
  },
  {
    ...
    price: "$9",
    period: "per month",
    desc: "For security professionals, developers, and small security teams.",
    features: [
      "Everything in Free",
      "Batch scan — up to 20 URLs at once",
      "Unlimited scan history & retention",
      "Full OWASP category reports (PDF)",
  ...
  },
  {
    ...
    price: "Custom",
    period: "contact us",
    desc: "For banks, telcos, and large security operations centres.",
    features: [
      "Everything in Pro",
      "Unlimited API access + SLA",
      "Custom brand & domain monitoring",
      "Threat intelligence feed (daily)",
      "ISO 27001-aligned compliance reports",
...
const TESTIMONIALS = [
  {
    name: "Amara O.",
    role: "IT Security Lead, Kano — Nigeria",
    body: "It flagged a fake UBA login page that looked pixel-perfect to the real one. The only tell was a .ml TLD — something our users would never have caught. African Cyber Shield caught it instantly.",
    stars: 5,
  },
  {
    name: "Tendai M.",
    role: "Banking Systems Analyst, Harare — Zimbabwe",
    body: "I shared the 2FA guide with my whole team. Three colleagues were nearly hit by SIM-swap attempts that month. The step-by-step Ecobank guide alone probably saved two of them their accounts.",
    stars: 5,
  },
  {
    name: "Nkechi A.",
    role: "Cybersecurity Trainer, Port Harcourt — Nigeria",
    body: "Seeing '1.5 seconds' next to their current password hits differently than any slide deck. I use the password crack-time display in every workshop I run — nothing creates urgency faster.",
    stars: 5,
  },
];
